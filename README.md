...
Proxy server that uses Claude and ChatGPT subscription OAuth tokens to call Anthropic and OpenAI APIs. Supports Claude Sonnet/Opus/Haiku and GPT-5.4/5.3/5.2 models through a single endpoint.
...
| Model | `model` value | Subscription |
|---|---|---|
